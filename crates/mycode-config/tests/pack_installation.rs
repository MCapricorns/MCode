...
fn canonical_round_trip_binds_family_and_pack_path() {
    ...
    for (family, raw_id) in [
        ...
        let expected = format!(
            "{{\"formatVersion\":1,\"kind\":\"mycode-pack-installation\",\"revision\":1,\"family\":\"{}\",\"packId\":\"{raw_id}\",\"source\":\"official-source\",\"selected\":{{\"version\":\"1.2.3-alpha.1+build.7\",\"digest\":\"{DIGEST}\"}},\"trustHighWater\":{{\"sequence\":7,\"manifestDigest\":\"{OTHER_DIGEST}\"}},\"inventory\":[{{\"path\":\"bin/main.wasm\",\"digest\":\"{DIGEST}\"}},{{\"path\":\"themes/dark.json\",\"digest\":\"{OTHER_DIGEST}\"}}]}}\n",
