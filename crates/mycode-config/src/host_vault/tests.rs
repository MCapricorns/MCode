...
fn document(revision: u64, credentials: &str, grants: &str) -> String {
    format!(
        "{{\"formatVersion\":1,\"kind\":\"mycode-host-auth\",\"revision\":{revision},\"credentials\":[{credentials}],\"grants\":[{grants}]}}\n"
    )
}
...
fn schema_shape_and_scalar_bounds_are_strict() {
    ...
    for invalid in [
        ...
        valid.replacen("\"kind\":\"mycode-host-auth\"", "\"kind\":7", 1),
        ...
        "{\"formatVersion\":1,\"formatVersion\":1,\"kind\":\"mycode-host-auth\",\"revision\":0,\"credentials\":[],\"grants\":[]}".into(),
    ] {
...
fn grants_validate_consumer_identity_pack_digest_order_and_references() {
    ...
    for invalid in [
        ...
        valid.replacen("com.mycode.providers", "com.mycode.web", 1),
    ...
    let later = grant("web", "com.mycode.web", "pack", "read", "alpha", "one");
