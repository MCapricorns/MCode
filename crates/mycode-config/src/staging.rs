...
mod tests {
    ...
    fn journal_parser_accepts_only_fixed_canonical_bytes() {
        ...
        for (bytes, state) in [
            (b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\"}\n".as_slice(), JournalState::Writing),
            (b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"staged\"}\n".as_slice(), JournalState::Staged),
            (b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"committing\"}\n".as_slice(), JournalState::Committing),
            (b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"committed\"}\n".as_slice(), JournalState::Committed),
        ] {
            assert_eq!(super::parse_journal(bytes, &id), Some(state));
        }

        for (label, bytes) in [
            ("reordered", b"{\"kind\":\"mycode-staging-transaction\",\"formatVersion\":1,\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\"}\n".as_slice()),
            ("duplicate", b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\",\"state\":\"writing\"}\n".as_slice()),
            ("unknown", b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\",\"extra\":0}\n".as_slice()),
            ("missing", b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\"}\n".as_slice()),
            ("wrong type", b"{\"formatVersion\":\"1\",\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\"}\n".as_slice()),
            ("wrong kind", b"{\"formatVersion\":1,\"kind\":\"other\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\"}\n".as_slice()),
            ("wrong id", b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-fedcba9876543210fedcba9876543210\",\"state\":\"writing\"}\n".as_slice()),
            ("future version", b"{\"formatVersion\":2,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\"}\n".as_slice()),
            ("future state", b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"future\"}\n".as_slice()),
            ("state type", b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":0}\n".as_slice()),
            ("CRLF", b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\"}\r\n".as_slice()),
            ("trailing", b"{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\"}\n\n".as_slice()),
            ("whitespace", b" {\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"tx1-0123456789abcdef0123456789abcdef\",\"state\":\"writing\"}\n".as_slice()),
            ("non UTF-8", b"\xff\xfe\n".as_slice()),
        ] {
        ...
        for mutation in ["claimed", "extra"] {
            ...
            super::platform::after_recovery_preflight_for_test(move || {
                ...
                "claimed" => std::fs::write(
                    ...
                    format!(
                        "{{\"formatVersion\":1,\"kind\":\"mycode-staging-transaction\",\"transactionId\":\"{id}\",\"state\":\"committing\"}}\n"
                    ),
                )
